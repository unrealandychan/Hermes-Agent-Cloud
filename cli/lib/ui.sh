...
post_deploy_guide() {
  ...
  gum style --bold --foreground 255 "  3.  Hermes Gateway & Web Dashboard"
  gum style --foreground 245        "      API Gateway:   http://${ip}:8080"
  gum style --foreground 245        "      Web Dashboard: http://${ip}:9119"
  ...
  echo ""
  gum style --foreground 245 "  c)  Open the web dashboard in your browser"
  gum style --foreground 245 "      http://${ip}:9119"
  echo ""
  ...
  echo ""
  gum style --foreground 245 "  •  SSH (port 22), gateway (port 8080), and web dashboard (port 9119) are"
  gum style --foreground 245 "     restricted to your current IP only. If your IP changes, re-run:"
  ...
  echo ""
  gum style --foreground 245 "  •  Do NOT open ports 8080 or 9119 to 0.0.0.0/0 unless you add"
